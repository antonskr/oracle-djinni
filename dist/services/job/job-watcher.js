...
const fs = __importStar(require("fs/promises")); // Используем промисы для работы с файловой системой
class JobWatcher {
    ...
    start(ctx) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.jobFetcher.fetchJobs(ctx); // Первичная загрузка данных
            this.intervalId = setInterval(() => __awaiter(this, void 0, void 0, function* () {
                yield this.jobFetcher.fetchJobs(ctx);
    ...
    isRunning() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const data = yield fs.readFile(this.statusFile, 'utf8');
    ...
    updateStatus(isRunning) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield fs.writeFile(this.statusFile, JSON.stringify(status, null, 2));
            }
            catch (error) {
